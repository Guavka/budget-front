...
const XMLHttpRequest_1 = __importDefault(require("../xml-http-request/XMLHttpRequest"));
const XMLHttpRequestUpload_1 = __importDefault(require("../xml-http-request/XMLHttpRequestUpload"));
const XMLHttpRequestEventTarget_1 = __importDefault(require("../xml-http-request/XMLHttpRequestEventTarget"));
...
const ProcessingInstruction_1 = __importDefault(require("../nodes/processing-instruction/ProcessingInstruction"));
const FileList_1 = __importDefault(require("../nodes/html-input-element/FileList"));
...
class Window extends EventTarget_1.default {
    ...
    constructor(options) {
        ...
        this.HTMLSelectElement = HTMLSelectElement_1.default;
        ...
        this.NamedNodeMap = NamedNodeMap_1.default;
        ...
        this.ProcessingInstruction = ProcessingInstruction_1.default;
        ...
        this.FileList = FileList_1.default;
        this.Headers = Headers_1.default;
        this.XMLHttpRequestUpload = XMLHttpRequestUpload_1.default;
        this.XMLHttpRequestEventTarget = XMLHttpRequestEventTarget_1.default;
        // Events
        this.onload = null;
        this.onerror = null;
        ...
        XMLHttpRequest_1.default._ownerDocument = document;
        ...
        class XMLHttpRequest extends XMLHttpRequest_1.default {
        }
